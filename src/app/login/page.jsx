...
export default function AuthenticationPage() {
  return (
    <div className="min-h-screen flex items-center justify-center">
      <div className="container relative hidden h-[800px] flex-col items-center justify-center md:grid lg:max-w-none lg:grid-cols-2 lg:px-0 overflow-hidden rounded-[0.4rem] border bg-background shadow-md md:shadow-xl">
        <Link
          href="/register"
          className={"absolute right-4 top-5 md:right-8 md:top-8"}
        >
          Sign Up
        </Link>
